...
DEFAULT_SETTINGS = {
    ...
    'paper_auto_steps': 1,
    'demo_symbols': ['BTCUSDT','ETHUSDT','SOLUSDT','XRPUSDT','AAVEUSDT','HYPEUSDT','XAUTUSDT',
                     'BARDUSDT','DOGEUSDT','BNBUSDT','AVAXUSDT','SUIUSDT','NEARUSDT','MNTUSDT','GRASSUSDT','MONUSDT',
                     'LTCUSDT','DOTUSDT','BIRBUSDT','ADAUSDT','VIRTUALUSDT','ZROUSDT','LITUSDT','ENAUSDT','ASTERUSDT',
                     'LINKUSDT','UNIUSDT','TONUSDT'],
    'demo_interval': '5',
